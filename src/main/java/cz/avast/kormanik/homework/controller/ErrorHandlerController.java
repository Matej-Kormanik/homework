...
public class ErrorHandlerController {
    ...
    public ResponseEntity<ErrorResponseTO> handleApplicationException(HomeworkApplicationException e) {
        ErrorResponseTO errorResponse = new ErrorResponseTO(e.getMessage(), BAD_REQUEST.getReasonPhrase(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponseTO> requestTimeOut(ResourceAccessException e) {
        ErrorResponseTO errorResponse = new ErrorResponseTO(e.getMessage(), REQUEST_TIMEOUT.getReasonPhrase(), LocalDateTime.now());
